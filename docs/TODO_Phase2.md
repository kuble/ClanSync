...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6c** `0023` **승부예측**·결과 확정·Premium **적중 코인 5**(개인 원장) |
...
- [ ] **M6c S04 밸런스메이커** — **부분**: `0016`~`0023` 세션·맵·영웅 밴·roster·M/A·Realtime·**승부예측·결과·코인 지급(MVP)**·세션 종료 · **잔여**: 배당 모델·클랜 풀·타이머·다른 게임 영웅 풀·내전 히스토리 연동

...
|------|------|------|-----------------------|
| D-UX-01 | OPEN (2026-09-16) | 게임 대기방 기준 내전 운영·구성원 조작 최소화 | **부분 확정:** 클랜원 목록 직접 선택과 기존 최근 참여순 정렬을 기본으로 유지(밸런스 페이지·S04 반영). **미결:** 직전 판 선택 재사용·대기방 화면 연결·PC 단축키, 밴픽·계정 요건. 정렬은 기존 설계이며 자동화 후보와 구분. 기존 D-EVENTS-01·D-PERM-01 유지 / [논의](./product-design-evolution.md#ux-01) |

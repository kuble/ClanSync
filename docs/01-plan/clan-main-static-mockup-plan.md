...
- 집계 단위는 **클랜**(경기 아카이브·클랜 승률·맵 분해·참여 순위). 상세 IA: **@docs/01-plan/clan-stats-plan.md** §9.
- **구현**: `view-stats` 에 KPI·필터·아카이브·참여율 순위·맵 승률 막대·(운영진) 밸런스 안내. 필터·테이블 갱신은 `mockup/scripts/clan-mock.js` (`mockStats*`).

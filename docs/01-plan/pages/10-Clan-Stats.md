...
| HoF 승·무·패 승률, 다승·세션 참여·출전·연승·예측 적중, 현재/지난 월·연 순위와 공개 상한 | 예측 적중률 최소 표본 확정, 당시 설정/정정 이력을 함께 보존하는 역대 스냅샷 |
| 정규 내전의 세션·완료 경기·순출전 인원·월 추이·맵·밴·편성·점수 차이·경매 로그 | 요일×시간대, 예상 우세의 실제 결과, 경매 회차별 상세·검색 |
| 본인 전적·연속·역할·맵·점수·참여 날짜·예측, 운영진의 역할별 아군/적군 관계 | 개인 비공개 오버라이드 영속화 후 일반 멤버의 허용된 관계/타인 기록, 상대별 표본 기준, 코인 상세 |

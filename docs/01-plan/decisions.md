...
| D-UX-03 | OPEN (2026-09-16) | 선호 기반 역할 추첨·편성 조건·추천 근거·점수 공개·맵 투표 용어 | **대상 확정:** 이미 정해진 출전자 10명의 역할만 배정. 역할별 선착순 모집의 대안으로 프로필 선호·공통 무작위 순서 배정을 검토. 추첨 방식·불가 역할·연속판 보정은 미결, 구현 전. 밸런스 명세·D-PERM-01·D-PRIV-01 / [논의](./product-design-evolution.md#ux-03) |

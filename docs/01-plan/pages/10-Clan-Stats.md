...
필터 제목은 옵션 위에 놓고 **부문 / 기간 / 연도 / 월 / 일자**로 짧게 표기한다. 부문·기간·역할은 탄성 세그먼트를 유지하고 연도·월·일자는 세로 휠(마우스 스크롤·터치·클릭·방향키·Home/End)로 선택한다. HoF는 전체/연도/월, 내전 통계·경기 기록은 월 안의 특정 일자까지 지원한다. 좁은 화면은 필터를 줄바꿈하고 긴 세그먼트 내부만 가로 스크롤한다.

...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6c** 경기 단계 **승부예측·결과 확정** UI 플레이스홀더(`match_live`) · 단계 라벨 ①~③ |
...
- [ ] **M6c S04 밸런스메이커** — **부분**: `0016`~`0020` 세션·맵 밴·**roster**·**M/A**·**Realtime**·**승부예측·결과 UI 플레이스홀더**·영웅 밴 플레이스홀더·세션 종료 · **잔여**: 승부예측·정산 **서버** 연동·영웅 밴 투표(Phase 2+)

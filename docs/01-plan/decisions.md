...
|------|------|------|-----------------------|
| D-UX-01 | OPEN (2026-09-16) | 게임 대기방 기준 내전 운영·구성원 조작 최소화 | **부분 확정:** 사용자 요청으로 클랜원 목록 직접 선택을 기본 사양으로 유지(밸런스 페이지·S04 반영). **미결:** 대기방 화면 연결·선택 보조·PC 단축키, 다음 판 변경 처리, 밴픽·계정 요건. 기존 D-EVENTS-01·D-PERM-01 유지 / [논의](./product-design-evolution.md#ux-01) |

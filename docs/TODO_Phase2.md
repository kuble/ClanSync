...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6c** 밸런스 세션·맵 밴 MVP(`0016`·운영진 `manage_clan_events`) |
...
- [ ] **M6c S04 밸런스메이커** — **부분**: `0016` `balance_sessions`·맵 밴(3후보·득표 가중 확정)·영웅 밴 플레이스홀더·세션 종료 · **잔여**: ① 배치 편집·실시간 동기·M/A 점수·슬롯·승부예측(Phase 2+ placeholder)

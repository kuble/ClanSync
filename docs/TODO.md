...
> **지금 라이브**: M6b 타 채널(카카오 옵트인)·대진 팀 라벨·**0041** 스크림… · **다음**: Phase 2+ 카카오 실 발송·대진 진행 코인연동 등 · **M6c** 완충 등 · [PHASE2_EXPERIENCE.md](./PHASE2_EXPERIENCE.md)
...
| **마지막 갱신** | 2026-05-14 — M6b 카카오 옵트인·브래킷 슬롯 라벨·TODO_Phase2 |

---

## 다음 세션 권장 프롬프트 (/todo 갱신 시 덮어씀)

**지금 단계(Phase 2 · M6b 완료 → M6c/M7 초점)** — 복사용:

```
@docs/TODO_Phase2.md 참고해서
Phase 2 **M6c 밸런스**/M7 미완 항목 중 우선 한 묶음(한 문장). Phase 2+ 이관 분(스크림 채팅·카카오 실 발송·브래킷 진행본) 지시 시 컨펌.

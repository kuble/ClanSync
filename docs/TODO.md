...
> **지금 라이브**: M6b (**0041** 스크림방…) · 수동 일정… · **다음**: 스크림 채팅(Phase 2+) · 카카오 등 타 채널 · **M6c** 완충 등 · [PHASE2_EXPERIENCE.md](./PHASE2_EXPERIENCE.md)
...
| **마지막 갱신** | 2026-05-13 — 스크림 단 필터 바(상태·티어·취소) |
...
Phase 2 M6b 잔여: 스크림 **앱** 플로(모집·매칭·확정 UI + Server Action 이중화) · 카카오 등 타 채널 · M6c 중 우선순위 한 줄 지정.

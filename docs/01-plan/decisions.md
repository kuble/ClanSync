...
|------|------|------|-----------------------|
| D-UX-01 | OPEN (2026-09-16) | 게임 대기방 기준 내전 운영·구성원 조작 최소화 | **부분 확정:** 최근 참여순 클랜원 직접 선택. 수동 보드는 게임 대기방과 같은 좌우 5칸·하단 관전자 구조. 대기방 화면 연결 적용, 게임사 문의는 후속(밸런스 페이지·S04 반영). **운영 확인:** 출전자 10명 유지·라운드 사이 변경 인원 교체. **미결:** 입력 진행·맞교환 등 UI 상세·OCR·플랜 범위·PC 보조앱·밴픽·계정 요건. 게임사 정책 적합성은 미확인. 기존 D-EVENTS-01·D-PERM-01 유지 / [논의](./product-design-evolution.md#ux-01) |

...
| 맵·유형별 빈도 | 도넛·비중·실제 경기 수 | 유형 필터. 7개 이상은 상위 5개+기타, 펼친 전체 목록에서 세부 확인 |
| 선호 맵 | 맵 선정 투표의 득표 도넛·표 수 | 선택 기간 완료 경기의 투표만. 맵 밴/최종 선정 횟수로 해석하지 않음 |
| 맵 투표·선정 (관리 전용) | **클랜 관리 → 개요**에서 후보 등장·득표·최종 선정 수치를 맵별로 나란히 표시 | 운영진이 집계 확인. 맵별 투표 상세 탐색은 후속 |
| 영웅 밴 | 도넛·확정 밴 건수·비중, 역할 필터 | 한 경기 복수 밴을 허용하므로 분모는 해당 역할의 전체 밴 건수. 상위 5개+기타 및 전체 목록 |

...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6b 일부** (`0013` event_notify · 관리 강퇴·역할 · Discord 웹훅 스텁 · 구독 패널) + M7 |
...
- [ ] **M6b S06 이벤트·관리·스토어** — **부분**: `0013` `event_notify` · 관리 강퇴(`banned`)·역할(클랜장 승격/강등)·구독(dev 플랜 토글 패널) · 이벤트 Discord 웹훅 URL 저장(MVP). **잔여**: 실 POST 알림 · **D-STORE** `coin_transactions`·차감 플로우

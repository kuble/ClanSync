...
|------|------|------|-----------------------|
| D-UX-01 | OPEN (2026-09-16) | 게임 대기방 기준 내전 운영·구성원 조작 최소화 | **부분 확정:** 최근 참여순 직접 선택·좌우 고정 역할·첫 빈칸 자동 입력·우클릭 삭제·직접 드래그 이동/교환. 관전자·체크·범례·별도 선택/교환 모드 제거. 대기방 화면 연결 적용·게임사 문의 후속(페이지·S04 반영). **운영:** 10명 유지·라운드 사이 교체. **미결:** 선택자 숨김안·추가 편의성·모바일·저장·OCR·플랜·PC 보조앱·밴픽·계정 요건. 게임사 정책 적합성 미확인. 기존 D-EVENTS-01·D-PERM-01 유지 / [논의](./product-design-evolution.md#ux-01) |

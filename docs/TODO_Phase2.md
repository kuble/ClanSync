...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6b** (스토어·Discord·D-STORE-02·**배너 슬롯→`banner_url`·대시보드**) |
...
- [ ] **M6b S06 이벤트·관리·스토어** — **부분**: `0013`~`0014` · 관리·구독·스토어·Discord·D-STORE-02·**클랜 배너 URL**(구매 검증 + 관리 폼 + 대시보드) · **잔여**: 프로필 입장 효과 연동·`purchases` 무효화·과금 카피

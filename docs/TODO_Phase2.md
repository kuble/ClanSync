...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6c** `0024` 예측 보상 **클랜 풀 차감**(`balance_prediction_payout`) |
...
- [ ] **M6c S04 밸런스메이커** — **부분**: `0016`~`0024` 세션·맵·영웅 밴·roster·M/A·Realtime·승부예측·결과·**클랜 풀 차감 후 개인 지급**·세션 종료 · **잔여**: 파리뮤추엘·마감 타이머·다른 게임 영웅 풀·내전 히스토리 연동

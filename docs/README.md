...
| 클랜 통계·사이트 이용 | [통계 로더](../src/lib/clan/stats/load-clan-stats.ts) · [집계 규칙](../src/lib/clan/stats/clan-stats-analytics.ts) · [통계 화면](../src/components/main-clan/clan-stats-experience.tsx) · [기간 집계](../src/lib/clan/stats/intra-overview.ts) · [명예의 전당 반응](../src/app/actions/hof-comments.ts) · [관리 방문 화면](../src/components/main-clan/clan-site-usage-panel.tsx) | [기간·권한 UI](../e2e/clan-stats-periods.spec.ts) · [집계](../e2e/clan-stats-analytics.spec.ts) · [기록/HoF](../e2e/clan-match-records.spec.ts) · [반응/댓글 권한](../e2e/hof-comments.spec.ts) · [권한 경계](../e2e/security-fix-boundaries.spec.ts) |
...
| 클랜 통계·역할별 함께한 기록/상대 전적 | [통계 명세](01-plan/pages/10-Clan-Stats.md) — 명예의 전당·내전 통계·경기 기록·개인 기록, 사이트 이용은 관리로 이전. 1차 구현 범위와 잔여 항목은 §7 참조 |

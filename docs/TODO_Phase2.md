...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6c** `0020` **M/A 스냅샷**(`ma_snapshot`)·**Realtime**(`balance_sessions`)·`match_live` 편집 |
...
- [ ] **M6c S04 밸런스메이커** — **부분**: `0016`~`0020` 세션·맵 밴·**roster**·**M/A 스냅샷**·**Realtime**·영웅 밴 플레이스홀더·세션 종료 · **잔여**: 승부예측·정산 연동(Phase 2+ placeholder)

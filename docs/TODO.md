...
> **지금 라이브**: M6b `/events` 본문 + **M5** 프로필 꾸미기 탭 새로고침 동기화 · **다음**: M6b 잔여(반복·RSVP·투표 DB·대진표 저장) 또는 M6c 잔여 · 체감 → [PHASE2_EXPERIENCE.md](./PHASE2_EXPERIENCE.md)
...
| **마지막 갱신** | 2026-04-28 — **M5** 프로필 뱃지/네임플레이트 저장 후 다른 게임 탭 데이터 동기화 (`CustomEvent` + `router.refresh`). 다음 = **M6b 잔여** 또는 **M6c 잔여**. |

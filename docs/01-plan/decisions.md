...
|------|------|------|-----------------------|
| D-UX-01 | OPEN (2026-09-16) | 게임 대기방 기준 내전 운영·구성원 조작 최소화 | **부분 확정:** 최근 참여순 직접 선택·좌우 5칸·딜딜탱힐힐 역할 고정·중앙 역할 아이콘. 이름 클릭으로 1팀 1~5→2팀 1~5 첫 빈칸 입력·우클릭 비우기. 관전자 영역·체크·자리 선택·맞교환·반복 위치 표기 제거. 선택 배경색 범례는 편성하기 행 왼쪽. 대기방 화면 연결 적용·게임사 문의 후속(페이지·S04 반영). **운영:** 10명 유지·라운드 사이 교체. **미결:** 보조 입력·저장·OCR·플랜·PC 보조앱·밴픽·계정 요건. 게임사 정책 적합성 미확인. 기존 D-EVENTS-01·D-PERM-01 유지 / [논의](./product-design-evolution.md#ux-01) |

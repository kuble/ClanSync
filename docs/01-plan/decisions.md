...
| D-UX-03 | OPEN (2026-09-16) | 편성 방식 선택·선호 역할 추첨·주장 지명·경매·편성 근거 | **역할 추첨 대상 확정:** 이미 정해진 10명. **추가 제안:** 기존 방식·선호 추첨·주장 지명·포인트 경매 선택, 역할 배정과 팀 구성 조합, 대회 활용. 역할 확정 시점·불가 역할·순번·예산·웹 조작 주체·다팀 범위·기존 점수 공개/용어는 미결, 구현 전. 밸런스 명세·D-PERM-01·D-PRIV-01 / [논의](./product-design-evolution.md#ux-03) |

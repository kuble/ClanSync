-- Round presentation settings may change after formation without changing the rules.
...
begin
  ...
  v_formation_changed :=
    (p_settings - array['showPlayerCardScore','showPlayerCardInfo','showTeamComparisonSummary','showPlayerSessionSummary','playerCardInfo']::text[])
    is distinct from
    (v_round.formation_settings - array['showPlayerCardScore','showPlayerCardInfo','showTeamComparisonSummary','showPlayerSessionSummary','playerCardInfo']::text[]);
  ...
  if p_settings is null or jsonb_typeof(p_settings) <> 'object' or
    ...
    jsonb_typeof(p_settings->'showTeamComparisonSummary') <> 'boolean' or
    jsonb_typeof(p_settings->'showPlayerSessionSummary') <> 'boolean' or
    ...
    (p_settings - array['roles','teams','captains','auctionBudget','minBid','durationSeconds','showPlayerCardScore','showPlayerCardInfo','showTeamComparisonSummary','showPlayerSessionSummary','playerCardInfo']::text[]) <> '{}'::jsonb then

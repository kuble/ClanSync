...
export const OW_HEROES: readonly OwHero[] = [
  { id: "dmon", nameKo: "D.Mon", role: "tank" },
  { id: "dva", nameKo: "D.Va", role: "tank" },
  { id: "domina", nameKo: "도미나", role: "tank" },
  { id: "doomfist", nameKo: "둠피스트", role: "tank" },
  { id: "hazard", nameKo: "해저드", role: "tank" },
  ...
  { id: "sierra", nameKo: "시에라", role: "dps" },
  { id: "shion", nameKo: "시온", role: "dps" },
  ...
  { id: "vendetta", nameKo: "벤데타", role: "dps" },
  ...
  { id: "jetpack_cat", nameKo: "제트팩 캣", role: "support" },

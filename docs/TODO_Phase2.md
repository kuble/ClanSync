...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6c** 세션·맵 밴·**5v5 roster**(`0019`·`list_balance_roster_pool`) |
...
- [ ] **M6c S04 밸런스메이커** — **부분**: `0016`~`0019` 세션·맵 밴·**roster JSONB(탱1·딜2·힐2×2)**·영웅 밴 플레이스홀더·세션 종료 · **잔여**: 실시간 동기·M/A 점수·승부예측(Phase 2+ placeholder)

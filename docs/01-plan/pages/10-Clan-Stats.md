...
| 경기 아카이브 | 날짜 버튼을 누르면 월간 달력 표시. 상시 주간 달력·별도 경기 수 표시는 제거. 블루·레드 팀을 각각 가로 한 줄로 배치하고 승리 팀 왕관·역할을 표시 | 날짜 행 오른쪽에 맵·참가자 필터. 날짜 선택 시 닫힘·포커스 복원, 방향키·PageUp/Down·Home/End·Escape 지원. 기간 범위 안에서 선택하며 검색해도 선택 날짜 유지 |

...
> 진행도: [허브](../IMPLEMENTATION_PROGRESS.md) · Phase 1 [체크·요약표](../IMPLEMENTATION_PROGRESS_Phase1.md) · [세션 로그](../IMPLEMENTATION_PROGRESS_SESSION_LOG.md) (히스토리)

| ID | 슬라이스 | 한 줄 | 상세 문서 |
|----|----------|-------|-----------|
| S00 | 규약·플랜 | Free/Premium 경계, 문서 사용법 | [slices/slice-00-conventions.md](./slices/slice-00-conventions.md) |
| S01 | 라우팅·쉘 | 랜딩, 로그인/가입, 게임 선택, 미들웨어 흐름 | [slices/slice-01-routing-shell.md](./slices/slice-01-routing-shell.md) |

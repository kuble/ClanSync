...
|------|------|------|-----------------------|
| D-UX-01 | OPEN (2026-09-16) | 게임 대기방 기준 내전 운영·구성원 조작 최소화 | 사용자: 게임 대기방으로 인원 파악, 신청·체크인 부담 지적. 운영진 명단 반영·다음 판 재사용으로 수정 제안. 밴픽·계정 요건은 미결. 기존 D-EVENTS-01·D-PERM-01 유지 / [논의](./product-design-evolution.md#ux-01) |

...
|------|-----|
| **단계** | Phase 2 — 앱 구현 |
| **마지막 갱신** | 2026-04-22 — **M6c** `0022` 맵·영웅 **투표 Realtime** (`ClanBalanceSessionRealtime`) |
...
- [ ] **M6c S04 밸런스메이커** — **부분**: `0016`~`0021` 세션·맵·**영웅 밴(OW)**·**roster**·**M/A**·**Realtime**·승부예측·결과 **UI** 플레이스홀더·세션 종료 · **잔여**: 승부예측·정산 **서버** 연동·다른 게임 영웅 풀

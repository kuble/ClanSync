...
> **지금 라이브**: M7 LFG 크론+in-app(`0042`) 반영 완료 · 메인허브 `?tab=` · 클랜 벨 게임 알림 포함 · 밸런스 M6c 포함 · **다음**: M5 잔여·`/board/[postId]` 등 Phase 2+·**M8** 감사
...
| **마지막 갱신** | 2026-05-12 — **M7** LFG 만료 in-app `0042`·MainGame `?tab=lfg` 깊링크 |

...
**초점:** 내전 로비·경기 흐름과 주장 지명·자동 경매·전략 아이템을 QA에서 확인한다.

## 실행 제약

- **QA 우선, 운영 DB·운영 배포 보류.** 작업 브랜치: `codex/live-session-formation`. QA 마이그레이션 80개·운영 50개이며 운영 적용 30개가 대기 중이다.
...
1. 현재 QA의 내전 로비·경기 진행 피드백 수정·해당 시나리오 확인.
   보안 7건·기능 오류 8건 수정 및 집중 검증 완료([근거](03-analysis/review-fixes-2026-09-23.md)).
   클랜 통계는 [3영역·역할별 관계 전적·UI/UX 기획](01-plan/pages/10-Clan-Stats.md) 문서화 완료. 항목별 표현·운영 우선순위·인터랙션까지 확정했으며 화면·집계·권한 구현은 대기한다.

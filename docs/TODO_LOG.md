...
- 무승부 입력·무보상 확정·다음 라운드와 무효 구분 집계를 추가했다. QA 68개 적용, 운영 50개 유지. 관련 DB 7건, 집계/점수 규칙 10건, PC·모바일·호버·키보드·권한·무승부 입력 E2E 1건, 린트·타입·빌드 통과. 정보창 접근성 연결과 소수 표시를 보완하고 임시 픽스처 정리 순서를 수정했다. 사용자 QA 명단은 유지했다.

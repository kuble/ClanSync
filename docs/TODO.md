...
> **지금 라이브**: M7 LFG 크론+in-app(`0042`) 반영 완료 · 메인허브 `?tab=` · 클랜 벨 게임 알림 포함 · 밸런스 M6c 포함 · 프로필 **부계동** `0043` · **다음**: `/board/[postId]` 등 Phase 2+ · **M8** 감사
...
| **마지막 갱신** | 2026-05-12 — **M7** LFG `0042` · **M5** 부계동 `0043` |

---

## 다음 세션 권장 프롬프트 (/todo 갱신 시 덮어씀)

**지금 단계(Phase 2 · M5 부계동·M7 포함 → M8 / Phase 2+)** — 복사용:

```
@docs/TODO_Phase2.md 참고해서
Phase 2+ **`/games/[g]/board/[postId]`** 또는 **M8 감사** 등 남은 범위 중 한 묶음(한 문장).

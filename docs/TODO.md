...
> **지금 라이브**: **M6c** 밸런스 플로 회귀 포함 · M6b 이벤트/스토어 · **0041** 스크림… · **다음**: M7(LFG 크론 등)·**M5** 잔여·M8 감사 · Phase 2+ 밸런스·대진 고도화 · [PHASE2_EXPERIENCE.md](./PHASE2_EXPERIENCE.md)
...
| **마지막 갱신** | 2026-05-14 — M6c 밸런스 E2E·시드·문서 마감(M6c 완료 표기) |

---

## 다음 세션 권장 프롬프트 (/todo 갱신 시 덮어씀)

**지금 단계(Phase 2 · M6c 완료 → M7/M5/M8)** — 복사용:

```
@docs/TODO_Phase2.md 참고해서
Phase 2 **M7 경량 잔여**(LFG 만료 cron 등) 또는 **M5 프로필** 잔여 또는 **M8 감사** 중 한 묶음(한 문장).
